...
import {getEvents, Event} from '../../../api/fetchEvents'
...
const [toggleEvents, toggleEventsSet] = useState<boolean>(false);
    ...
    //Dummy
    const dummyHighlightedAd: Event = {
        country: 'Poland',
        city: 'HighlightTest',
        street: 'HighlightTest',
        paricipantAmount: 0,
        description: 'HighlightTest',
        background: 'HighlightTest',
        shouldBeBlack: false,
        creator: 'Test'
    }
    //Dummy
