    ...
    return (
        <EventsHolder>
            ...
            <EventsField toggle={toggleEvents}>
                <HighlightField toggle={toggleEvents} onClick={redirectToMeSection}>
                ...
                {(loading || events.length === 0) && <Dashboard key={page} toggle={toggleEvents} page={page} chunk={null} main={true} showDetails={showDetails} applyClass={applyClass}/>}
