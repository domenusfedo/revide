...
const Events = () => {
    ...
    const [openMore, openMoreSet] = useState<boolean>(false);
    ...
    const scrollHandler = (e: any) => {
        ...
        //scroll up handler and check with state to not fetch redundant
